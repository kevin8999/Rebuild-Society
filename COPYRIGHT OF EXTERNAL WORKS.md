...
- OpenStax: varies by book. License is contained inside the book.)
...
- Unsplash: [License | Unsplash](https://unsplash.com/license)
	- Used for photos
- United States Government: Works from the United States (US) government are public domain within the US. The same may not be true outside of the US[^1].

[^1]: https://www.usa.gov/government-copyright

The list of current US government agencies whose works are used in this project include:
